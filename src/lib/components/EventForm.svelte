...
<form method="POST" use:enhance class="space-y-6">
	<div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
		...
		<div>
			...
			<input
				...
				class="mt-1 block w-full rounded-md border-gray-300 font-mono text-sm shadow-sm focus:border-purple-500 focus:ring-purple-500"
			/>
			<p class="mt-1 text-xs text-gray-500">URL-safe identifier (e.g. "june-2025-book-club")</p>
		</div>
		...
		<div class="sm:col-span-2">
			<label for="canonical_url" class="block text-sm font-medium text-gray-700">
				Canonical Event URL
			</label>
			<input
				type="url"
				...
				class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"
			/>
			<p class="mt-1 text-xs text-gray-500">Link back to the event page on the main Astro site</p>
		</div>
		...
		<div class="flex items-center gap-3 self-end pb-2">
			...
			/>
			<label for="waitlist_enabled" class="text-sm font-medium text-gray-700">
				Enable waitlist
			</label>
		</div>
	</div>
	...
	<div class="flex items-center justify-between border-t border-gray-200 pt-6">
		<a href={resolve('/admin')} class="text-sm text-gray-500 hover:text-gray-700"> Cancel </a>
		<button
			type="submit"
			class="rounded-md bg-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-purple-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600"
		>
